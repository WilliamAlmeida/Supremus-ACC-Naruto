...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		{{ Form::open(array('action' => 'CategoriasNoticiasController@getAdicionar')) }}
		...
		<fieldset class="form-group">
			...
			<div class="form-group row">
				...
				<div class="col-lg-10">
					{{ Form::text('meta_title', null, array('placeholder' => 'Titulo', 'class' => 'form-control')) }}
				</div>
			</div>
			<div class="form-group row">
				{{ Form::label('meta_description', 'Meta Descrição', array('class' => 'col-lg-2 form-control-label')) }}
				<div class="col-lg-10">
					{{ Form::textarea('meta_description', null, array('placeholder' => 'Resumo da categoria', 'class' => 'form-control')) }}
				</div>
			</div>
			<div class="form-group row">
