...
@section('title', ('Top 100 ').Lang::choice('content.player', 2))
@section('sub_title', '')
...
<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
	<div class="row m-b conteudo">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p-b p-t">
			{{ Form::open(array('action' => 'PlayersController@getRanking', 'class' => 'form', 'name' => 'filtro_ranking', 'method' => 'get')) }}
...
<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 conteudo m-b">
	<div class="row m-b">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 m-b p-b p-t titulo">
			<h3 class="foNW foNS m-z p-z hidden-sm hidden-xs">{{ Lang::get('content.top 100 players of the') }} {{ $configuracoes->title or 'App Name' }}</h3>
			<h5 class="m-z p-z hidden-lg hidden-md">{{ Lang::get('content.top 100 players of the') }} {{ $configuracoes->title or 'App Name' }}</h5>
		</div>
...
<script type="text/javascript" async="async">
	$(document).ready(function(){
		$('form[name=filtro_ranking] input[name=name]').val('{{ (Input::has("name")) ? Input::get("name") : "" }}');
